...
$(function() {
    ...
    // -- Tableau indexé d'objet Contact ⚠️ 
    ...
    function ajouterContact(Contact) {
        ...
        // -- Ajouter "Contact" dans "CollectionDeContacts" ⚠️ 
        CollectionDeContacts.push(Contact);
        console.log(CollectionDeContacts);
        
        // -- On cache la phrase : Aucun Contact ⚠️ 
        $('.aucuncontact').hide();

        // -- Mise à jour du HTML ⚠️ 
        $(`
            <tr>
                <td>` + Contact.nom + `</td>
        ...
        // -- Réinitialisation du Formulaire ⚠️ 
        reinitialisationDuFormulaire();

        // -- Affiche une Notification ⚠️ 
    ...
    function unContactEstPresent(Contact) {
        ...
        // -- Booleen qui indique la présence d'un contact dans ma collection ⚠️ 
    ...
    // -- Détection de la soumission de mon formulaire  ⚠️ 
    $('#contact').on('submit', function(e) {

        // -- Stopper la redirection de la page ⚠️ 
        e.preventDefault();

        // -- Récupération des champs à vérifier ⚠️ 
        ...
        if(mesInformationsSontValides) {
             ...
             * Sinon, on peut procéder à la suite du traitement ⚠️ 
             */
