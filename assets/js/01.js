...
###
|
| Depuis ECMA 6, vous pouvez déclarer une variable avec le 
| mot-clé "let".

| Votre variable sera alors accessible uniquement dans le bloc
| dans lequel elle est contenue. Càd, déclarée.
...
* uniquement en lecture. Sa valeur ne pourra pas êtr modifiée par
